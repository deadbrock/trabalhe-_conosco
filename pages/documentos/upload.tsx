...
export default function DocumentosUploadPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen at-page flex items-center justify-center">
        <ArrowPathIcon className="w-12 h-12 animate-spin text-[#354A80]" />
      </div>
    );
  }

  return (
    <div className="min-h-screen at-page p-4">
      {/* Header */}
